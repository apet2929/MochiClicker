...
public class MainRoom extends Room {
    ...
    public MainRoom(int roomTexture) {
        ...
        Cat bob = new Cat("Bob", new Texture("Tiger.png"), new Texture("tiger_sleep.png"), new Texture("paige_idle.png"), 0, 0, 100, 70, this);
        bob.sendToMainRoom();
        addCat(new Cat("Bob", new Texture("Tiger.png"), new Texture("tiger_sleep.png"), new Texture("paige_idle.png"), 0, 0, 100, 70, this));
        initDecorations();
    }
